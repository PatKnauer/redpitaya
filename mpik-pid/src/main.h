...
#define PARAMS_NUM        153 // changed by Fenske----(126)------changed again by patrick------------------------
...
#define PID_11_COUNT_KI   69

#define PID_12_ENABLE     70
#define PID_12_RESET      71
// added and changed by Fenske--------------------------------------------------------------------
#define PID_12_ARESET     72
#define PID_12_GAIN       73
#define PID_12_SP         74
#define PID_12_KP         75
#define PID_12_KI         76
#define PID_12_KD         77
#define PID_12_LIMIT_UP   78
#define PID_12_LIMIT_LOW  79
#define PID_12_INT_LIMIT  80
#define PID_12_KII        81
#define PID_12_COUNT_KI   82

#define PID_21_ENABLE     83
#define PID_21_RESET      84
// added and changed by Fenske--------------------------------------------------------------------
#define PID_21_ARESET     85
#define PID_21_GAIN       86
#define PID_21_SP         87
#define PID_21_KP         88
#define PID_21_KI         89
#define PID_21_KD         90
#define PID_21_LIMIT_UP   91
#define PID_21_LIMIT_LOW  92
#define PID_21_INT_LIMIT  93
#define PID_21_KII        94
#define PID_21_COUNT_KI   95

#define PID_22_ENABLE     96
#define PID_22_RESET      97
// added and changed by Fenske--------------------------------------------------------------------
#define PID_22_ARESET     98
#define PID_22_GAIN       99
#define PID_22_SP         100
#define PID_22_KP         101
#define PID_22_KI         102
#define PID_22_KD         103
#define PID_22_LIMIT_UP   104
#define PID_22_LIMIT_LOW  105
#define PID_22_INT_LIMIT  106
#define PID_22_KII        107
#define PID_22_COUNT_KI   108

#define OUT_1_OFFSET	  109
#define OUT_2_OFFSET	  110
#define MIN_I_THRESHOLD_1 111
#define MIN_I_THRESHOLD_2 112
#define MIN_INTENS_1      113
#define MIN_INTENS_2      114

#define MEAS_P_CH1        115 //------ bar graph Fenske
#define MEAS_I_CH1        116
#define MEAS_D_CH1        117
#define MEAS_O_CH1        118
#define MEAS_P_CH2        119 //------ bar graph Fenske
#define MEAS_I_CH2        120
#define MEAS_D_CH2        121
#define MEAS_O_CH2        122

#define ROT_ENCODER	  123
#define SAVE_SETTINGS	  124
#define LOAD_SETTINGS	  125

#define AO_ENABLE_PIN0	  126		//patrick - AO and slow piezo correction parameters
#define AO_ENABLE_PIN1	  127
#define AO_ENABLE_PIN2	  128
#define AO_ENABLE_PIN3	  129
#define AO_VOL_PIN0	  130
#define AO_VOL_PIN1	  131
#define AO_VOL_PIN2	  132
#define AO_VOL_PIN3	  133
#define PIEZO_ENABLE	  134
#define AO_TRSH_UP	  135
#define AO_TRSH_DOWN      136
#define PULSE_TIMER	  137		
#define PULSE_LEN	  138
#define PROD_PULSE	  139		
#define VALUE0		  140
#define LL_TIMER	  141
#define TIMERLIMIT	  142
#define LASER_LOCK_VALUE  143
#define LL		  144		
#define DEV_CHECKS	  145		
#define DEV_IN_V	  146		
#define PIEZO_MANUAL	  147		
#define MANUAL_DIR	  148		
#define MANUAL_GO	  149		
#define MANUAL_TIMER	  150		
#define MANUAL_NOP	  151
#define SLOW_PULSES	  152		//patrick - end

/*when adding new parameters keep in mind that the improved save function only contains numbers (not variables that define these numbers, sorry I am lazy) for the new settings and that their position e.g. in the list might change*/
...
#define PARAMS_PER_GEN    7 // changed by Fenske --------------------------------------

/* Defines from which parameters on are PID parameters (used in set_param() to
 * trigger update only on needed part - either Oscilloscope, AWG or PID */
#define PARAMS_PID_PARAMS 57
#define PARAMS_PER_PID    13 // changed by Fenske --------------------------------------

//patrick - parameter index for AO settings
#define PARAMS_AO_PARAMS  126
