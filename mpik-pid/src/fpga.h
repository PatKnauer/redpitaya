...
/** Starting address of FPGA registers handling asg-register.----------------------------------------------------------------------- Fenske */
#define ASG_FPGA_BASE_ADDR 	0x40200000
...
/* --------------------------------------------------------------------- Fenske*/
/** Offset to the memory buffer where signal on OUTPUT is captured. */
//#define OSC_FPGA_CHO_OFFSET    0x20000
...
int   osc_fpga_get_sig_ptr(int **cha_signal, int **chb_signal); //, int **cho_signal); //--------------------- Fenske
