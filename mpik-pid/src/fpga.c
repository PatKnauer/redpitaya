...
/* @brief Pointer to data buffer where signal on OUTPUT is captured.  ------------- Fenske*/
static uint32_t           *g_osc_fpga_cho_mem = NULL;
...
// extern void* my_map_base; ---------------------------------------------------Fenske
